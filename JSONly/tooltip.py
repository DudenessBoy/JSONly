# This code includes the `tooltip` module from Python's `idlelib` module.
# `idlelib` is part of the Python standard library, distributed under the Python Software Foundation License (PSFL).
# Modifications are marked where applicable.
# Original copyright: © Python Software Foundation.
...
# Removed original logic for testing tooltips, as it uses a module that may not be available on all systems