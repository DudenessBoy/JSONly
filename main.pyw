...
def mainWindow() -> None:
    ...
    about.add_command(label = lang['menubar.about.website'], command = lambda: webbrowser.open(LINKS['website']))
    about.add_command(label = lang['menubar.about.repo'], command = lambda: webbrowser.open(LINKS['repo']))
